...
const CardItem = ({
  ...
  return (
   <div className="group">
   <div className="min-w-fit min-h-fit  pb-6 border border-orange-400 duration-250 group-hover:border-blue-400 shadow-xl rounded-2xl cursor-pointer flex flex-col justify-center items-center">
    <div className="py-8">
      <h1 style={{fontFamily:"Cabinet"}} className="text-center text-gray-700 font-medium text-xl">{title}</h1>
      <p style={{fontFamily:"GeneralSans"}} className="text-center text-slate-400 text-sm">{shortDesctiption}</p>
    </div>
